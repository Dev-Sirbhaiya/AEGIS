  ...
  return (
    <div className="flex items-center gap-2 px-3 py-2 border-t border-white/5">
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 bg-aegis-cyan/20 hover:bg-aegis-cyan/30 border border-aegis-cyan/50 text-aegis-cyan text-xs font-mono font-bold rounded transition-all hover:shadow-[0_0_8px_rgba(68,147,248,0.35)] disabled:opacity-50"
      >
        <UserCheck size={14} />
        TAKE OVER
      </button>
