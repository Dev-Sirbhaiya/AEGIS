...
The app source currently lives in `aegis`.

## Fastest Way to Run

```powershell
cd C:\AEGIS\aegis
python scripts\easy_run.py
```

That one command will create the local backend env file if needed, prepare dependencies if needed, index and seed first-run data, and start both the backend and frontend.

Quick links:

- [Easy Run Guide](aegis/docs/EASY_RUN.md)
- [Detailed Run Guide](aegis/docs/HOW_TO_RUN.md)
- [Demo Guide](aegis/docs/DEMO_GUIDE.md)
...
- emergency and intercom call handling
...
- daily summary view
- monthly trend view
- predictive hotspot and risk view
...
Detailed instructions live in [aegis/docs/HOW_TO_RUN.md](aegis/docs/HOW_TO_RUN.md).
...
- Local backend reads `aegis/backend/.env`
- Docker Compose reads `aegis/.env`

## Quick Start

### 1. Add your API key

For local development, create `aegis/backend/.env`.
...
- Local fallback and demo behavior is intentional and helps keep the experience stable during demos
...
- [Run Guide](aegis/docs/HOW_TO_RUN.md)
- [Easy Run Guide](aegis/docs/EASY_RUN.md)
- [Product Requirements](PRD_AEGIS.md)
- [System Spec](AEGIS_SPEC.md)
